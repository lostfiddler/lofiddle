...
export function article() {
    ...
    render(
        ...
        a <a href='https://en.wikipedia.org/wiki/Gaussian_function'>mathmatical function</a> 
        that defines the probability of any given value occuring as a function of 
    ...
    fragment.append(title, para1, foo(9), foo(45), para2, canvasApp(), codeExample)
    //console.log(p.randomGaussian(10))
    return fragment;
}
